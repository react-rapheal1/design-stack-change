  ...
  return (
    ...
    >
      <div className="flex flex-1 justify-start">
        <Pagination.PrevTrigger asChild>
          <Button iconLeading={ArrowLeft} color="secondary" size="sm" className="hidden md:inline-flex">
            Previous
          </Button>
        </Pagination.PrevTrigger>
        <Pagination.PrevTrigger asChild>
          <Button iconLeading={ArrowLeft} color="secondary" size="sm" className="md:hidden" />
        </Pagination.PrevTrigger>
      </div>
      ...
      <div className="flex flex-1 justify-end">
        <Pagination.NextTrigger asChild>
          <Button iconTrailing={ArrowRight} color="secondary" size="sm" className="hidden md:inline-flex">
            Next
          </Button>
        </Pagination.NextTrigger>
        <Pagination.NextTrigger asChild>
          <Button iconTrailing={ArrowRight} color="secondary" size="sm" className="md:hidden" />
        </Pagination.NextTrigger>
      </div>
    </Pagination.Root>
  );
  ...
  return (
    <div className={cx("border-t border-secondary px-4 py-3 md:px-6 md:pt-3 md:pb-4", className)}>
      ...
      <nav aria-label="Pagination" className={cx("hidden items-center gap-3 md:flex", align === "center" && "justify-between")}>
        ...
        <span className={cx("text-sm font-medium text-fg-secondary", align === "right" && "order-first mr-auto", align === "left" && "order-last ml-auto")}>
          Page {page} of {total}
        </span>
