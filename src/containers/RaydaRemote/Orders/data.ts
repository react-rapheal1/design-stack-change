...
import { FlagGb, FlagMy, FlagPt, FlagUs, FlagUy, FlagZa } from "@untitledui/country-flags";
...
export const orders: Order[] = [
  ...
  },
  {
    id: "ORD-1005",
    date: "Oct 1, 2022",
    orderedBy: "Lana Steiner",
    payment: "Credit card",
    status: "in-progress",
    total: "$1,170,000",
    employeeCount: 12,
    type: "off-boarding",
    signature: "partial-required",
    country: "uy",
  },
  {
    id: "ORD-1004",
    date: "Sep 1, 2022",
    orderedBy: "Demi Wilkinson",
    payment: "Wallet",
    status: "completed",
    total: "$208,500",
    employeeCount: 9,
