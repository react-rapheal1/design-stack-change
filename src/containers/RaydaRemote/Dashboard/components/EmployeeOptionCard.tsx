...
interface EmployeeOptionCardProps {
  icon: IconComponent;
  title: string;
  description: string;
  recommended: boolean;
...
export function EmployeeOptionCard({ icon: Icon, title, description, recommended, isSelected, onClick }: EmployeeOptionCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
