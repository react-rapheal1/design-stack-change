...
function DeclineRFQModal({ isOpen, onClose, onConfirm, rfqId }: { isOpen: boolean; onClose: () => void; onConfirm: () => void; rfqId: string }) {
          ...
          <div className="relative overflow-hidden rounded-xl bg-white shadow-xl">
            ...
            <div className="flex flex-col gap-4 px-6 pt-6">
              ...
              <div className="flex flex-col gap-1">
                {" "}
                <h3 className="text-lg font-semibold text-[#181d27]"> Decline RFQ #{rfqId} </h3>{" "}
